...
public:
  ...
  void displayMessage() {
    ...
    getline(cin, b);
    cout << "I see," << a
         << ",I will try to my best to give you overview of C++" << endl;
    /* cout<<"After the next pause, I'll open that folder I which you save my
     file"<<endl; cout<<"YOu can type dir to see folders in it"<<endl;*/
    /*system("pause");
    system("cmd start /i");
    ...
    if ((yesapproval == "Y") || (yesapproval == "y")) {
      cout << "\t\t\t -------------------------------------------{C++ "
              "Overview}-------------------------------------------\t\t\t"
           << endl;
      string Intro("What is C++,C++ is an object-oriented programming "
                   "language. It is an extension to C programming,");
      string Intro1("Our C++ tutorial includes all topics of C++ such as first "
                    "example,control statements,objects \nand "
                    "classes,inheritance,constructor,destructor,this,static,"
                    "polymorphism,abstraction,abstract "
                    "class,interface,namespace,encapsulation,arrays,strings,"
                    "expression handling,File IO,etc.");
    ...
    if ((user_say == "Y") || (user_say == "y")) {
      string intro1(
          ...
          "programming.C++ is a middle-level language,as it encapsulates both "
      ...
      system("pause");
      string intro2(
          "C++ supports the object-oriented programming,the four major pillar "
          "of object oriented programming used in C++ are:");
      string intro3(
          "\n1.Inheritance\n2.Polymorphism\n3.Encapsulation\n4.Abstraction");
    ...
    string intro2("C++ supports the object-oriented programming,the four major "
                  "pillar of object oriented programming used in C++ are:");
    string intro3(
        "\n1.Inheritance\n2.Polymorphism\n3.Encapsulation\n4.Abstraction");
    string yesapproval1;
    cout
        << "Would you like to see Object-Oriented Programming(OOPs),Type(Y/N):";
    ...
    string stlibraries1(
        "\n->The core library includes the data types, variables and "
        "literals,etc.\n->The standard library includes the set of functions "
        "manipulating strings,files,etc.\n->The Standard Template Library "
        "(STL)includes the set of methods manipulating a data structures.");
    string yesapproval2;
    ...
    string Cdiffer(
        "1.follows the procedural style programming and C++ is "
        "multi-paradigm.It supports both procedural and object "
        "oriented.\n2.Data is C++,you can use modifiers for class members to "
        "make it inaccessible for outside users.\n3.C follows the top-down "
        "approach and C++ follows the bottom-up approach.\n4.Support function "
        "overloading and C++ supports function overloading.\n5.In C,you can't "
        "use structure and In C++,you can use functions in structure.\n6.C "
        "does not support reference variables and C++ supports reference "
        "variables.\n7.In C,scanf() and  printf() are mainly used for "
        "input/output and C++ mainly uses stream cin and cout to perform input "
        "and ouput operations.\n8.Operator overloading is not possible in C "
        "and Operator overloading is possible in C++.\n9.C programs are "
        "divided into procedures and modules and C++ programs are divided into "
        "functions and classes.\n10.C does not provide the feature of "
        "namespace and C++ supports the feature of namespace.\n11.Exception "
        "handling is not easy in C.It has to perform using other functions and "
    ...
    string cpphistory(
        ...
        "discuss brief history of C++ language.\nC++ programming was developed "
        "in 1980 by Bjarne Stroustrup at bell laboratories of AT&T (American "
        "Telephone & Telegraph) located in USA.\nBjarne Stroustrup is known as "
        ...
        "the C component.\nC++ programming is'relative'(called a superset)of "
        "C,it means any valid C program is also a valid C++ program.\nLet's "
        "see the programming languages that were developed before C++ "
        "language.");
    string cpphistory1(
    ...
    string cppfeatures(
        ...
        "provides a lot of features that are given below.\n1.Simple\n2.Machine "
        "Independent or Portable\n3.Mid-level Programming "
    ...
    string cppfeatures1(
        ...
        "structured approach(to break the problem into parts),rich set of "
        "library functions,data types etc.\n2.Machine Independent or "
        "Portable:\nUnlike assembly language,C programs can be executed in "
        "many machines with little bit or no change but it is not platform "
        "independent.\n4.Structured Programming language:\nC++ is a structured "
        "programming language in the sense that we can break the program into "
        ...
        "dynamic memory allocation.In C++ language,we can free the allocated "
        "memory at any time by calling the free() function.\n7.Speed:\nThe "
        "compilation and execution time of C++ language is "
        "fast.\n9.Recursion:\nIn C++,we can call the function within the "
        "function.It provides code reusability for every "
        "function.\n10.Extensible:\nC++ language is extensible because it can "
        "easily adopt new features.\n11.Object Oriented:\nC++ is object "
        "oriented programming language.OOP's makes development and maintenance "
        "easier where as in Procedure-oriented programming language it is not "
        ...
        "our program using compiler and then we can execute our program");
    ...
    if ((ya7 == "Y") || (ya6 == "y")) {
      cout << "\t\t\t -------------------------------------------{C++ Basic "
           ...
           << endl;
      string cppbasic(
          "C++I/O operation is using the stream concept.Stream is thee "
          "sequence of bytes or flow of data.It makes the performance "
          "fast.\nIf bytes flow from main memory to device like "
          "printer,display screen,or a network connection,etc,this is called "
          "as output operation.\nIf bytes flow from device like "
          "printer,display screen,or a network connection,etc to main "
          "memory,this is called as input operation.\n\nI/O Library Header "
          "Files\nLet us see the common header files used in C++ programming "
          "are:\nHeader\t\t\tFunction and description\n<iostream>\t\tIt is "
          "used to define the cout,cin and cerr objects,which correspond to "
          "standard output stream,standard input stream and standard error "
          "stream,respectively\n<iomainip>\t\tIt is used to declare services "
          "useful for performing formatted I/O,such as setprecision and "
          "setw.\n<fstream>\t\tIt is used to declare services for "
          "user-controlled file processing.");
      cout << cppbasic << endl;
      system("pause");
      cout << "STANDARD OUTPUT STREAM(COUT)" << endl;
      string cppbasic1(
          "The cout is a predefined object of ostream class.It is connected "
          "with the standard output device,which is usually a display "
          "screen.\nThe cout is used in conjunction with stream insertion "
          "operator(<<)to display the output on a console\n\nLet's see the "
          "simple example of standard output "
          "stream(cout):\n\n#include<iostream>\nusing namespace std;\nint "
          "main(){\nstring");
      cout << cppbasic1 << endl;
      system("pause");
      ...
      string cppbasic2(
          "\nThe cin is a predefined object of istream class.It is connected "
          "with the standard input device,which is usually a keyword.\nThe cin "
          "is used in conjuction with stream extraction operator(>>)to read "
      ...
      string cppbasic3("\nThe endl is a predefined onject of ostream class.It "
                       "is used to insert a new line stringacters and flushes "
                       "the stream.\n\nLet's see the simple example of "
    ...
    if ((ya8 == "Y") || (ya8 == "y")) {
      cout << "\t\t\t -------------------------------------------{C++ "
           ...
           << endl;
      string cppvariable(
          "C++ Variable:\nA variables is a name of memory location.It is used "
          "to store data.Its value can be changed and it can be reused many "
          "times.\nIt is a way to represent memory location through symbol so "
          "that it can be easily identified.\nLet's see the syntax to declare "
          "a variable:\n\ttype variable_list;\n\nThe example of declaring "
          "variable is given below:\n\tint x;\n\tfloat y;\n\tstring z;\nHere "
          "x,y,z are variables and int,float,string are data types.\n\nWe can "
          "also provide values while declaring the variables as given "
          "below:\n\tint x=5,b=10;//declaring 2 variables of integer "
          "type\n\tfloat f=30.8;\n\tstring c='A';");
      ...
      string cppvariable1(
          ...
          "reserved word or keyword e.g.string,float etc.\n\tValid variable "
          "names:\n\tint a;\n\tint_ab;\n\tint a30;\n\tInvalid variable "
          "names:\n\tint 4;\n\tint x y;\n\tint double;");
    ...
    string cppdatatype(
        ...
        "variable can store such as integer,floating,stringacter etc.\nThere "
        "are 4 types of data types in C++ Language.\nType\t\t\t\t\tData "
        "Types\nBasic Data Type\t\t\t\tint,string,float,double,etc.\nDerived "
        "Data Type\t\t\tarray,pointer,etc.\nUser Defined Data "
        "Type\t\t\tstructure.");
    string cppdatatype1(
        "Basic Data Types:\nThe basic data types are integer-based and "
        "floating-point based.C++ language supports both signed and unsigned "
        "literals.\nThe memory size of basic data types may change according "
        "to 32 or 64 bit operating system.\n\nLet's see the basic data "
        "types.It size is given according to 32 bit OS.\n\n");
    string cppdatatype2(
        "Data types:\t\t\t\t\tMemory Size:\t\t\t\tRange:\nstring\t\t\t\t\t\t1 "
        "Byte\t\t\t\t\t-128 to 127\nSigned string\t\t\t\t\t1 "
        "Byte\t\t\t\t\t-128 to 127\nUnsigned string\t\t\t\t\t1 Byte\t\t\t\t\t0 "
        "to 127\nShort\t\t\t\t\t\t2 Byte\t\t\t\t\t-32,768 to 32,768\nSigned "
        "Short\t\t\t\t\t2 Byte\t\t\t\t\t-32,768 to 32,768\nint\t\t\t\t\t\t2 "
        "Byte\t\t\t\t\t-32,768 to 32,768\nSigned int\t\t\t\t\t2 "
        "Byte\t\t\t\t\t-32,768 to 32,768\nUnsigned int\t\t\t\t\t2 "
        "Byte\t\t\t\t\t0 to 32,768\nShort int\t\t\t\t\t2 Byte\t\t\t\t\t-32,768 "
        "to 32,768\nSigned Short int\t\t\t\t2 Byte\t\t\t\t\t-32,768 to "
        "32,768\nUnsigned short int\t\t\t\t2 Byte\t\t\t\t\t0 to 32,767\nlong "
        "int\t\t\t\t\t4 Byte\t\t\t\t\tNA\nSigned long int\t\t\t\t\t4 "
        "Byte\t\t\t\t\tNA\nUnsigned long int\t\t\t\t4 "
        "Byte\t\t\t\t\tNA\nfloat\t\t\t\t\t\t4 "
        "Byte\t\t\t\t\tNA\ndouble\t\t\t\t\t\t8 Byte\t\t\t\t\tNA\nLong "
        "double\t\t\t\t\t10 Byte\t\t\t\t\tNA\n\n\tNOTE:(NA stands for Not "
        "Available)");
    string ya9;
    ...
    if ((ya10 == "Y") || (ya10 == "y")) {
      ...
      string cppkeyword2(
          ...
          "C Language are given "
          "below:\ndynamic_cast\t\tnamespace\t\treinterpret_"
          "cast\nexplicit\t\tnew\t\ttemplate\t\tfriend\noperator\t\tstatic_"
          "cast\nthis\t\tinline\t\tpublic\nthrow\t\tprivate\t\tfalse\ndelete\t"
          "\tmutable\t\tprotected\ntypeid\t\ttypename\t\tusing\nwstring_"
          "t\t\ttry\t\tconst_"
          "cast\nbool\t\tclass\t\tcatch\nasm\t\tvirtual\t\ttrue");
      cout << cppkeyword << setw(5) << cppkeyword1 << setw(5) << cppkeyword2
           << endl;
      system("pause");
